...
def save_checkpoint(epoch, arch, model, extras=None, is_best=None, name=None, output_dir='.', optimizer=None, model_ema=None):
    ...
    checkpoint = {
        ...
        'bank': model.module.banks if hasattr(model, 'module') else model.banks, 
        'arch': arch,
        'extras': extras,
